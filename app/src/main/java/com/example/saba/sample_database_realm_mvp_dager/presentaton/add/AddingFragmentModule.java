...
public class AddingFragmentModule {
    ...
    @Provides
    @PerFragment
    static AddingFragmentPresenterImpl provideAddingFragmentPresenter(SaveDataUseCase saveDataUseCase) {
        return new AddingFragmentPresenterImpl(saveDataUseCase);
    }
