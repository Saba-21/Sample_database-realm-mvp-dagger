...
public class ResultFragmentModule {
    ...
    @Provides
    @PerFragment
    static ResultFragmentPresenterImpl provideResultFragmentPresenter(SelectAllUseCase selectAllUseCase, DropUseCase dropUseCase) {
        return new ResultFragmentPresenterImpl(selectAllUseCase, dropUseCase);
    }
